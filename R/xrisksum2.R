...
#'    \code{xrisksum2} and nested functions are called hundreds of times in
...
# xrisksum2_BC <- function (y, xinc, direction, pars) {
#
#   xmax = (1- y * y) ^ 0.5
#
#   imax = as.integer (xmax/xinc)
...
#
#   if(imax > 0) {
#     risk = risk + (pcollxy_0/2 + pcollxy_imax/2) * xinc
#     for (k in 1: (imax - 1)) {
#       risk = risk + pcollxy(k*xinc, y, direction, pars) * xinc
#     }
#   }
#
#   2*risk
...
#'
#'
#' @param flight_type a numeric value. 1 = flapping, 0 = gliding, indicating the
