...
one seabird species and one turbine/windfarm scenario, with fictional
...
1.  Suggest how input parameter data sets used in the previous
    ...
    applications, as the wide tabular format of these data sets is
    likely preferred structure for users to gather input parameters
    under different scenarios.

2.  Set up the groundwork to run stoch\_crm() for multiple species and
    windfarm/turbines features.
