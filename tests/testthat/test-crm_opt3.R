...
test_that("crm_opt3() return equates Band spreadsheet output (page 2) - case 2", {

  # Case 2 - Kittiwake, 98% avoidance, specific wind farm features
  expect_equal(
    crm_opt3(
      rotor_grids = generate_rotor_grids(chord_prof = chord_prof_5MW),
      d_y_gen = band_spreadsheet_dt_2$d_y,
